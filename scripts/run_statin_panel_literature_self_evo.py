...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Execute PubMed lead searches for route-closure blocker follow-up queries.",
    )
    parser.add_argument("--closure-followup-limit", type=int, default=1)
    parser.add_argument(
        "--execute-all-closure-followups",
        action="store_true",
        help="Execute PubMed lead searches for every queued route-closure blocker.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Execute field-level PubMed lead searches for every open gap.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Probe every selected open-gap lead for access metadata.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Execute signal-only PMC extraction for every open-access open-gap lead.",
    )
