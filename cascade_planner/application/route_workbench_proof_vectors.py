"""Compile independent edge and route proof axes for workbench projections."""
...
def edge_proof_vector(*, edge: Mapping[str, Any], proof: Mapping[str, Any], graph: Mapping[str, Any]) -> dict[str, Any]:
    records = [
