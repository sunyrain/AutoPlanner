...
_SHIMS = (
    CompatibilityShim(
        ...
        removal_milestone="P9 after CLI/API/WebUI use the V4 service",
    ...
    CompatibilityShim(
        ...
        removal_milestone="P9 after legacy campaign resume migration",
    ...
    CompatibilityShim(
        ...
        replacement="cascade_planner.application.deficit_frontier",
        removal_milestone="P9 after legacy report export migration",
    ...
    CompatibilityShim(
        ...
        removal_milestone="P9 after legacy route export migration",
        telemetry_source="parent blackboard compatibility event",
    ),
    CompatibilityShim(
        ...
        removal_milestone="P9 after legacy closeout report migration",
        telemetry_source="parent blackboard compatibility event",
    ),
    CompatibilityShim(
    ...
    CompatibilityShim(
        ...
        removal_milestone="P9 after remaining legacy actions become workers",
    ...
    CompatibilityShim(
        ...
        replacement="cascade_planner.orchestration.global_campaign_director",
        removal_milestone="P9 after blackboard entrypoint retirement",
        telemetry_source="parent blackboard compatibility event",
    ),
)
