...
from cascade_planner.legacy.eval_runtime.compare_controller_runs import (
    compare_controller_runs,
    write_markdown as write_delta_markdown,
)
from cascade_planner.legacy.eval_runtime.controller_v2_reports import build_reports
from cascade_planner.legacy.eval_runtime.candidate_miss_audit import audit_candidate_misses
from cascade_planner.legacy.eval_runtime.stock_failure_audit import build_stock_failure_audit
from cascade_planner.legacy.eval_runtime.audit_stock_closed_alternatives import (
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("reservoir_distill_matrix")
    main()
