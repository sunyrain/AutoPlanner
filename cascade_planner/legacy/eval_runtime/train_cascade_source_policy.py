...
from cascade_planner.legacy.eval_runtime.build_route_tree_source_policy_pack import (
    FAILURE_LABELS,
)
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy cascade source-policy trainer")
    main()
