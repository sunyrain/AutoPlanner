...
from cascade_planner.legacy.cascade_search_runtime.v4_product_value import canonical_smiles
from cascade_planner.legacy.eval_runtime.audit_candidate_specific_evidence import (
    _candidate_evidence_scores,
    _train_bank,
)
from cascade_planner.legacy.eval_runtime.audit_v4_heldout_block_recovery import (
    _connected_step_pairs,
    audit_v4_heldout_block_recovery,
)
from cascade_planner.legacy.eval_runtime.replay_block_coherence_on_route_pool import (
    _main_reactant,
)
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("replay_ccts_v3_on_route_pool")
    main()
