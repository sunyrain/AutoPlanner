...
def main() -> None:
    ...
    ap.add_argument(
        "--output",
        default="archive/data/legacy_eval_202605/benchmark_condition_rich_20260507.json",
    )
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy condition-rich benchmark selector")
    main()
