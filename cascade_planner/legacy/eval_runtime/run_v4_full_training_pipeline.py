...
def plan_v4_full_training_pipeline(
    *,
    ...
    benchmark_runner = benchmark_runner or [
        "python",
        "-m",
    ...
    commands.append(
        {
            ...
            "cmd": _join_cmd(
                [
                    "python",
                    "-m",
                    "cascade_planner.legacy.eval_runtime.build_cascade_pair_pack",
                    "--v4-jsonl",
    ...
    commands.append(
        {
            ...
            "cmd": _join_cmd(
                [
                    "python",
                    "-m",
                    "cascade_planner.legacy.eval_runtime.train_cascade_pair_scorer",
                    "--pack-dir",
                    str(pair_pack_dir),
                    "--model-output",
                    str(pair_model),
    ...
    commands.append(
        {
            ...
            "cmd": _join_cmd(
                [
                    "python",
                    "-m",
                    "cascade_planner.legacy.eval_runtime.build_cascade_action_value_pack",
    ...
    commands.append(
        {
            ...
            "cmd": _join_cmd(
                [
                    "python",
                    "-m",
                    "cascade_planner.legacy.eval_runtime.build_cascade_transition_pack",
        ...
        [
            {
                ...
                "cmd": _join_cmd(
                    [
                        "python",
                        "-m",
                        "cascade_planner.legacy.eval_runtime.train_cascade_action_value",
                        "--pack-dir",
                        str(pack_dir),
                        "--model-output",
                        str(action_model),
            ...
            },
            {
                ...
                "cmd": _join_cmd(
                    [
                        "python",
                        "-m",
                        "cascade_planner.legacy.eval_runtime.train_cascade_source_value",
                        "--pack-dir",
                        str(pack_dir),
                        "--model-output",
                        str(source_model),
            ...
            },
            {
                ...
                "cmd": _join_cmd(
                    [
                        "python",
                        "-m",
                        "cascade_planner.legacy.eval_runtime.train_cascade_transition_value",
                        "--pack-dir",
                        str(transition_pack_dir),
                        "--model-output",
...
def _commands_script(commands: list[dict[str, Any]]) -> str:
    lines = [
        ...
        "set -euo pipefail",
        "",
        "# Generated by cascade_planner.legacy.eval_runtime.run_v4_full_training_pipeline.",
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("v4 full action/source value training pipeline")
    main()
