...
def mask_full_step(board: CascadeBoard, rng: random.Random) -> TrainingSample:
    ...
    for field_name in ["reaction_type", "ec", "T", "pH", "solvent", "reaction_smiles"]:
        setattr(slot, field_name, None)
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy CascadeBoard training-data generation")
    main()
