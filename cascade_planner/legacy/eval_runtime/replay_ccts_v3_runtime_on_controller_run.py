...
from cascade_planner.legacy.eval_runtime.replay_ccts_v3_on_controller_run import (
    _counts,
    _parse_float_tuple,
    _parse_int_tuple,
    _policy_delta,
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("replay_ccts_v3_runtime_on_controller_run")
    main()
