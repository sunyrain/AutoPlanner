...
def build_route_pool_review_calibration_packet(
    *,
    ...
    command = (
        "python -m cascade_planner.legacy.eval_runtime.run_route_pool_evidence_review_csv_pipeline "
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("build_route_pool_review_calibration_packet")
    main()
