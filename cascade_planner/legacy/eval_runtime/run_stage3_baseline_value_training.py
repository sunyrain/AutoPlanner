...
from cascade_planner.legacy.eval_runtime.build_cascade_action_value_pack import (
    build_cascade_action_value_pack,
)
from cascade_planner.legacy.eval_runtime.build_cascade_transition_pack import (
    build_cascade_transition_pack,
)
from cascade_planner.legacy.eval_runtime.train_cascade_action_value import (
    train_cascade_action_value,
)
from cascade_planner.legacy.eval_runtime.train_cascade_source_value import (
    train_cascade_source_value,
)
from cascade_planner.legacy.eval_runtime.train_cascade_transition_value import (
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("stage3 baseline value training runner")
    main()
