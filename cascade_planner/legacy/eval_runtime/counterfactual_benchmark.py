...
from cascade_planner.legacy.eval_runtime.cascadeboard_training_data import (
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy CascadeBoard counterfactual benchmark")
    main()
