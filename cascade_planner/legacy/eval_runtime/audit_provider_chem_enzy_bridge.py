...
from cascade_planner.legacy.eval_runtime.audit_provider_routepool_oracle import (
    _load_reference_blocks,
    _retrieve,
    _transition_fp,
)
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy v4/provider research script")
    main()
