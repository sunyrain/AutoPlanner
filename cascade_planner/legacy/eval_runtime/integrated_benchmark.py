...
from cascade_planner.legacy.eval_runtime.learned_scorer import (
    load_scorer,
    score_route,
    SlotFeatures,
)
...
def run_benchmark(
    ...
    print(f"\n{'='*60}")
    print("INTEGRATED BENCHMARK RESULTS (OA-ARM + Learned Scorer)")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy CascadeBoard integrated benchmark")
    import argparse
