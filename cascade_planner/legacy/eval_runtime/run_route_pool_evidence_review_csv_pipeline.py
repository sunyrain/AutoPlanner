...
from cascade_planner.legacy.eval_runtime.ingest_route_pool_evidence_review_csv import (
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("run_route_pool_evidence_review_csv_pipeline")
    main()
