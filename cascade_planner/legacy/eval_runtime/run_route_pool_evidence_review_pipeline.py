...
from cascade_planner.legacy.eval_runtime.build_route_pool_evidence_review_prompts import (
    build_route_pool_evidence_review_prompts,
)
from cascade_planner.legacy.eval_runtime.calibrate_route_pool_evidence_review_signals import (
    calibrate_route_pool_evidence_review_signals,
)
from cascade_planner.legacy.eval_runtime.gate_route_pool_evidence_review_promotion import (
    gate_route_pool_evidence_review_promotion,
)
from cascade_planner.legacy.eval_runtime.ingest_route_pool_evidence_review_results import (
    ingest_route_pool_evidence_review_results,
)
from cascade_planner.legacy.eval_runtime.run_route_pool_evidence_llm_review import (
    run_route_pool_evidence_llm_review,
)
from cascade_planner.legacy.eval_runtime.summarize_route_pool_evidence_review_labels import (
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("run_route_pool_evidence_review_pipeline")
    main()
