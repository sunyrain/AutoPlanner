...
from cascade_planner.legacy.eval_runtime.benchmarks import _make_cached_graph, _within_energy_margin
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy CascadeBoard policy benchmark")
    main()
