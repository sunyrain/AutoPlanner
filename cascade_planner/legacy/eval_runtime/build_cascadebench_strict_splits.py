...
from cascade_planner.legacy.eval_runtime.build_v4_trace_benchmark import (
    collect_v4_trace_candidates,
)
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy CascadeBench strict-split builder")
    main()
