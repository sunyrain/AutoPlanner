...
from cascade_planner.eval.chem_enzy_broad_union import _convert_chem_route
    ...
    *,
    ...
    if chem_routes:
        ...
        routes.extend(
            _convert_chem_route(
                route,
                native_rank=route.get("_native_rank"),
                stock_closed=chem_route_stock_closed(route),
            )
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("build_reservoir_distill_pack")
    main()
