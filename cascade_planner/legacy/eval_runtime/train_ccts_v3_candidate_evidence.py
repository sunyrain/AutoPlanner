...
from cascade_planner.legacy.eval_runtime.audit_candidate_specific_evidence import (
    _candidate_evidence_scores,
    _train_bank,
)
from cascade_planner.legacy.eval_runtime.train_ccts_v0_transition_ranker import (
    CandidateDataset,
    _baseline_scores,
...
from cascade_planner.legacy.eval_runtime.train_ccts_v1_transition_ranker import (
    _coverage_leakage_report,
)
from cascade_planner.legacy.eval_runtime.train_ccts_v2_sparse_labels import (
    _add_block_support,
...
from cascade_planner.legacy.eval_runtime.train_ccts_v2_transition_ranker import (
    _build_schema,
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("train_ccts_v3_candidate_evidence")
    main()
