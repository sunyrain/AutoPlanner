...
from cascade_planner.legacy.eval_runtime.real_benchmark import run_real_benchmark
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy CascadeBoard ablation benchmark")
    main()
