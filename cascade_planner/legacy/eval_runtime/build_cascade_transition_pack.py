...
from cascade_planner.legacy.cascade_search_runtime.transition_value import transition_reward
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy cascade transition pack builder")
    main()
