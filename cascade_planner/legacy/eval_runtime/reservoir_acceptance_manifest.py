    ...
    *,
    ...
    for label in labels:
        ...
        cmd = [
            ...
            "--worker-module cascade_planner.legacy.route_tree_runtime.live_benchmark",
            "--check-stock",
            f"--workers {workers}",
            f"--device {device}",
    ...
    matrix_cmd = [
        "PYTHONPATH=.",
        "python -m cascade_planner.legacy.eval_runtime.reservoir_distill_matrix",
    ...
    manifest = {
        ...
        "quality_review_gates": {
            ...
            "note": "Use cascade_planner.legacy.eval_runtime.audit_stock_closed_alternatives on stock-closed non-GT routes before strong usability claims.",
        },
        "notes": [
            "Run with cascade_planner.legacy.eval_runtime.run_pipeline_manifest_commands.",
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("reservoir_acceptance_manifest")
    main()
