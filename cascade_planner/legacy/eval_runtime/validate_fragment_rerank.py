...
from cascade_planner.legacy.eval_runtime.train_cascade_fragment_scorer import (
    FragmentScorerNetwork,
    fragment_feature_vector,
)
from cascade_planner.legacy.cascade_search_runtime.pair_scorer import pair_rule_features
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy cascade-fragment rerank validator")
    main()
