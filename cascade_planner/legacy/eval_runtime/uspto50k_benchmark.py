...
Usage:
    ...
    python -m cascade_planner.legacy.eval_runtime.uspto50k_benchmark --model aizynth --data data_external/uspto50k/

    # With Syntheseus models (need model weights):
    python -m cascade_planner.legacy.eval_runtime.uspto50k_benchmark --model megan --model-dir /path/to/megan/
    python -m cascade_planner.legacy.eval_runtime.uspto50k_benchmark --model localretro --model-dir /path/to/localretro/
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy K2 USPTO-50K benchmark runner")
    main()
