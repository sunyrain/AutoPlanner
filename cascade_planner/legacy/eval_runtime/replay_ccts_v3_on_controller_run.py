...
from cascade_planner.legacy.eval_runtime.replay_ccts_v3_on_route_pool import (
    _score_route,
    _transform_pair_stats,
)
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("replay_ccts_v3_on_controller_run")
    main()
