...
Usage
-----
  .\\.venv_aizynth\\Scripts\\python.exe -m cascade_planner.legacy.eval_runtime.eval_aizynthfinder \\
...
if __name__ == "__main__":
    ...
    require_legacy_research_enabled("legacy AiZynthFinder step benchmark")
    main()
