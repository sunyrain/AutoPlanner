...
合并自：
- `docs/archive/2026-05/AutoPlanner_Cascade_阶段性汇报_2026-05-19.md`
...
> **📑 PPT 全脚本**：完整 39 张正片 + 8 张 Backup 的逐页文案与图描述见 [docs/archive/2026-05/AutoPlanner_PPT_Full_Script_2026-05-19.md](archive/2026-05/AutoPlanner_PPT_Full_Script_2026-05-19.md)（覆盖关键问题 / 设计阶段 / 当前架构 / 国际 SOTA / 未来主线）。
...
| 区域 | 状态 |
| --- | --- |
| `cascade_planner/cascade_search/` | Active research：cascade search、condition state、verifier value hooks、subgoal proposals |
| `cascade_planner/eval/` 中的 CCTS / v4 learned-value / provider-retrieval / old value / rerank / ablation 脚本 | Guarded archive 或 research-only：用于复现和 ablation，不是 Web default |
...
2026-05-20 cleanup: the frozen lines above now require
`AUTOPLANNER_ALLOW_LEGACY_RESEARCH=1` for direct execution. See
`docs/MAINLINE_CLEANUP_2026-05-20.md` and
