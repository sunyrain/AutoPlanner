...
1. [CURRENT_ARCHITECTURE_STATUS.md](CURRENT_ARCHITECTURE_STATUS.md)：当前 V4 宿主主线的实现状态与迁移门。
2. [SYNTHEX_COMPONENT_CONTRACT.md](SYNTHEX_COMPONENT_CONTRACT.md)：冻结的 paper-aligned V8 组件合同，
   也是判断 V9 与 SynthEx 论文差异的复现基线。
3. [archive/paper-aligned-v8-20260826/BASELINE.md](archive/paper-aligned-v8-20260826/BASELINE.md)：
   2026-08-26 论文对齐基线、正式运行证据和已知局限；对应 Git 引用
   paper-aligned-v8-freeze-20260826。
4. [V9_CAUSAL_TRANSACTIONAL_RETROSYNTHESIS.md](V9_CAUSAL_TRANSACTIONAL_RETROSYNTHESIS.md)：
...
6. [../MAINLINE.md](../MAINLINE.md)：当前 Canonical V4 运行主干及完成定义。
