...
FOCUSED_LINE_BUDGETS = {
    ...
    "cascade_planner/application/route_innovation_discovery.py": 380,
    ...
    "cascade_planner/interfaces/campaign_recovery_stores.py": 40,
    ...
    "cascade_planner/orchestration/program_innovation_runtime.py": 90,
