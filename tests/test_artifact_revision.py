...
from cascade_planner.harness.schemas import FinalVerdict
...
from cascade_planner.web.app import _agent_runtime_payload
from scripts.evaluate_agentic_run import evaluate_run
from scripts.refresh_agentic_closeout_artifacts import refresh_agentic_closeout_artifacts
...
def test_failed_new_controller_closeout_preserves_prior_cas_decision(
    ...
    monkeypatch.setattr(
        "cascade_planner.harness.agentic_blackboard_controller.publish_closeout_revision",
        fail_publish,
    )
