...
from cascade_planner.legacy.harness_runtime import (
    agentic_blackboard_controller as controller_module,
)
...
def test_consensus_refresh_keeps_hashed_portfolio_and_runtime_bindings_as_siblings(
    ...
    with (
        ...
        patch(
            "cascade_planner.legacy.harness_runtime.agentic_blackboard_controller.solve_diverse_routes",
