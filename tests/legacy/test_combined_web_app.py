...
import cascade_planner.legacy.web_runtime.app as web_app
from cascade_planner.agent.codex_worker import WorkerRunRecord
from cascade_planner.legacy.web_runtime.app import (
...
class WebAppTest(unittest.TestCase):
    ...
    def test_worker_trace_api_defaults_to_codex_backend(self):
        ...
        with patch.dict(web_app.os.environ, {"AUTOPLANNER_WEB_ENABLE_REAL_WORKER_TRACE": "1"}):
            with patch("cascade_planner.legacy.web_runtime.app.run_codex_worker", return_value=record) as run_worker:
