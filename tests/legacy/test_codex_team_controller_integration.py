...
import cascade_planner.legacy.harness_runtime.agentic_blackboard_controller as controller_module
...
from cascade_planner.legacy.orchestration_runtime.codex_retrosynthesis import RetrosynthesisTeamConfig
...
def test_resume_failure_does_not_restore_unreplayed_prior_campaign(
    ...
    monkeypatch.setattr(
        ...
        lambda *args, **kwargs: BrokenRegistry(),
    )
    ...
    monkeypatch.setattr(
        controller_module,
        "build_legacy_provider_registry",
        lambda *args, **kwargs: RejectedRegistry(),
    )
