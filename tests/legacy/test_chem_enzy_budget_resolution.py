...
from cascade_planner.legacy.harness_runtime.failure_critic import (
    compile_failure_critic_report,
)
...
def test_guided_entry_applies_standard_floor_and_records_attempt(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setattr("cascade_planner.legacy.harness_runtime.tools._execute_chemenzy_request", fake_execute)
...
def test_native_guided_and_child_outcomes_require_host_verified_route(
    ...
    monkeypatch.setattr(
        "cascade_planner.legacy.harness_runtime.tools.compile_route_failure_feedback",
        fake_feedback,
    )
    monkeypatch.setattr(
        "cascade_planner.legacy.harness_runtime.tools.write_route_failure_feedback",
