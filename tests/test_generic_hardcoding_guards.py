...
def test_generic_planner_and_projection_surfaces_have_no_target_name_branches() -> None:
    ...
    surfaces = (
        root / "cascade_planner/harness/codex_action_planner.py",
        root / "cascade_planner/harness/tools.py",
        root / "cascade_planner/harness/route_forest.py",
        root / "cascade_planner/harness/source_detail_chain_builder.py",
    )
